...
public record EstagioResponseDTO(Aluno aluno, Orientador orientador, Coordenador coordenador, Integer cargaDiaria, LocalDate dataInicio, LocalDate dataTermino, Boolean status, Boolean obrigatorio) {
